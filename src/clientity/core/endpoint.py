...
class Endpoint:
    ...
    if t.TYPE_CHECKING:
        R = t.TypeVar('R')
        def __or__(self, call: Call) -> "Bound['Endpoint', t.Any]": ...
        def __and__(self, call: Call) -> "Bound['Endpoint', t.Any]": ...
        def __mod__(self, model: Requesting) -> "Bound['Endpoint', t.Any]": ...
        def __matmul__(self, path: str) -> "Bound['Endpoint', t.Any]": ...
        def __lshift__(self, model: Requesting) -> "Bound['Endpoint', t.Any]": ...

        @t.overload
        def __rshift__(self, model: t.Type[R]) -> "Bound['Endpoint', R]": ...
        @t.overload
        def __rshift__(self, model: Responding) -> "Bound['Endpoint', t.Any]": ...
        def __rshift__(self, model: t.Any) -> "Bound['Endpoint', t.Any]": ...
