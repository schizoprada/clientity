...
class __ResourceFactory:
    def __call__(self, location: Locatable = "") -> Resource: return Resource(location)
    def __matmul__(self, path: Locatable) ->  Resource: return Resource(path)

resource = __ResourceFactory()
